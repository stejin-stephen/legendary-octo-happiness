...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tools&task=logs.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_tools&view=logs'); ?>" method="post"
