 ...
 * @since  1.6
 */
class ToolsViewItems extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_TOOLS_TITLE_ITEMS'), 'link news');
		...
		JHtmlSidebar::setAction('index.php?option=com_tools&view=items');
	}
