...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tools&task=items.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_tools&view=items'); ?>" method="post"
	...
	<div class="span9 main-container">
		<div id="j-main-container"> 
			...
			<table class="table table-striped" id="itemList">
				...
				<th class="left">
								<?php echo JHtml::_('searchtools.sort', 'Type', 'a.`type`', $listDirn, $listOrder); ?>
</th>
