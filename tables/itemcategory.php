 ...
 * @since  1.6
 */
class ToolsTableitemcategory extends JTable
{
	/**
	...
	{
		parent::__construct('#__tools_categories', 'id', $db);
		$this->_observers = new JObserverUpdater($this);
		JObserverMapper::attachAllObservers($this);
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'ToolsTableitemcategory', array('typeAlias' => 'com_tools.itemcategory'));
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_tools.itemcategory.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_tools/access.xml',
				"/access/section[@name='itemcategory']/"
			);
			$default_actions = JAccess::getAssetRules('com_tools.itemcategory.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('ItemCategory', 'ToolsTable');
	...
	protected function _getAssetName()
	{
		...
		return 'com_tools.itemcategory.' . (int) $this->$k;
	}
